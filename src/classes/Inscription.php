...
class Inscription
{
    ...
    /**
     * Tableau des erreurs de validation des données
     * et des règles métier
     * @var array
     */
    private $errors = [];
    ...
    private function validateInput(){
        ...
        var_dump("Validation saisie = ". ! $this->hasErrors());
    ...
    private function validateBusinessRules(){
        ...
        var_dump("Validation règle métier = ". ! $this->hasErrors());
        var_dump($this->errors);
    ...
    /**
     * Enregistrement de la personne et du compte utilisateur dans la base de données
     */
